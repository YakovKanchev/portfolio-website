...
public class WaitTool {
	 ...
	 */
	public List<WebElement> waitForListElementsPresent(WebDriver driver,
			final By by, int timeOutInSeconds) {
	 ...
	 * @author Mark Collin
	 */
	public WebElement waitForElementRefresh(WebDriver driver,
			final By by, int timeOutInSeconds) {
		WebElement element;
		try {
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(0)); // nullify
	 ...
	 * @return boolean
	 */
	public boolean waitForTextPresent(WebDriver driver, final By by,
	 ...
	 *         reached)
	 **/
	public boolean waitForJavaScriptCondition(WebDriver driver,
